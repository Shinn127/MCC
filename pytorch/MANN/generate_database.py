...
# files = [
#     ('../../Dataset/lafan1_retarget/pushAndStumble1_subject5.bvh', 350, 700, 'idle'),
#     ('../../Dataset/lafan1_retarget/walk1_subject5.bvh', 180, 15555, 'walk'),
#     ('../../Dataset/lafan1_retarget/run1_subject5.bvh', 200, 14156, 'run'),
# ]
...
Input = np.concatenate(X, axis=0).astype(np.float32)
Output = np.concatenate(Y, axis=0).astype(np.float32)

print(Input.shape)
print(Output.shape)

np.savez_compressed('./100sty_re.npz', X=Input, Y=Output)
